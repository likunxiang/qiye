<template>
	<div v-loading="loading">
		<el-tree :data="tableData" :props="defaultProps" highlight-current @node-expand="getSon"
			@node-click="getClassDate"></el-tree>
	</div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getNation(data) {
				await getNation().then(res => {
					if (res.OK == 'True') {
						if (res.Tag.length) {
