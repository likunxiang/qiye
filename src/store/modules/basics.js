const basics = {
  state: {
    ...
    img_url_plate: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/PLATES/IMGS/',  // 板块图片文件夹
    file_url_plate: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/PLATES/FILES/',  // 板块文件文件夹
